...
<body>
  ...
  <main>
    <section class="section">
      <h2>Introduction</h2>
      <p>Welcome to the Motion Sensor People Counter project! This project allows you to detect and count the number of people present in a specific area using an Arduino and a PIR motion sensor. By integrating a simple circuit and some code, this system can help track the number of people in a room or space, giving real-time feedback on occupancy. This is useful for applications in smart homes, offices, or event spaces.</p>
    </section>

    <section class="section">
      <h2>About Me</h2>
      <p>Hi, I'm Vedant! I'm 10 years old, and I love coding, playing soccer, and playing video games. I play for Cupertino FC, and my favorite video games are Fortnite and Minecraft. I also enjoy building PCs, learning about them, and building robots. I love coding games using languages like Python, Java, and others. My birthday is on February 10th, and I am always excited to learn more about technology and improve my skills!</p>
    </section>
